...
const ProjectCard = ({ project, index }: ProjectCardProps) => {
  ...
  return (
    ...
    >
      <PinContainer
        title={project.title}
        href={project.liveLink || project.githubRepo}
      ...
      >
        <div className="group relative h-full w-72 mx-auto overflow-hidden rounded-2xl bg-black p-1 transition-all duration-700 hover:scale-[1.02]">
          ...
          <div 
            ...
            style={{
              background: 'linear-gradient(125deg, #9333ea, transparent 40%, transparent 60%, #7e22ce 100%)',
          ...
          <div className="relative h-full w-full rounded-xl bg-zinc-950 p-4 overflow-hidden z-20">
            ...
            <div className="absolute inset-0 w-full h-full overflow-hidden opacity-0 group-hover:opacity-20 transition-opacity duration-700">
              <div className="absolute top-0 left-[10%] w-[80%] h-[1px] bg-purple-500/50" style={{animation: 'techLineScan 3s infinite'}}></div>
              <div className="absolute top-[50%] left-0 w-full h-[1px] bg-purple-500/30" style={{animation: 'techLineScan 5s infinite'}}></div>
              <div className="absolute bottom-[20%] left-0 w-full h-[1px] bg-purple-500/40" style={{animation: 'techLineScan 7s infinite', animationDelay: '1s'}}></div>
              <div className="absolute top-0 left-[20%] w-[1px] h-full bg-purple-500/30" style={{animation: 'techLineVertical 8s infinite'}}></div>
              <div className="absolute top-0 right-[30%] w-[1px] h-full bg-purple-500/20" style={{animation: 'techLineVertical 6s infinite', animationDelay: '2s'}}></div>
            </div>
            ...
            <div className="relative h-44 w-full rounded-lg overflow-hidden mt-2 perspective-800">
              ...
              <div 
                ...
                style={{
                  backgroundImage: 'linear-gradient(to bottom, transparent 70%, rgba(0, 0, 0, 0.8) 100%)',
                }}
              ></div>
