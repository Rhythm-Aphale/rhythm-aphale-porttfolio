      ...
      <div className="relative z-10">
        <div className="mb-4 flex items-start justify-between">
          <div>
            ...
            <h4 className="mb-1 text-lg font-medium text-blue-400">
              {company}
            </h4>
  ...
  const experiences = [
    {
      ...
      points: [
        ...
        "Integrated UI libraries and custom components to deliver seamless user experiences",
        "Implemented animations and interactive transitions using Framer Motion",
        "Optimized web performance with techniques such as code splitting and lazy loading",
        "Used GitLab for version control, collaboration, and managing feature branches",
        "Collaborated closely with designers to achieve pixel-perfect implementations",
        "Participated in regular code reviews and adhered to best practices for clean, maintainable code",
      ],
      skills: [
        "React",
        "Next.js",
  ...
  return (
    ...
    >
      ...
      <LampContainer>
        ...
        >
          <motion.h1 className="mt-8 bg-gradient-to-br from-blue-200 via-blue-300 to-blue-500 py-4 bg-clip-text text-center text-4xl font-bold tracking-tight text-transparent md:text-7xl">
